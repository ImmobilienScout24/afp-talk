...
\author{Valentin Haenel \href{https://twitter.com/esc\_\_\_}{@esc\_\_\_}}

\title{The AFP Project:\\Secure Cloud Authentication for Machines and Humans}
\definecolor{gray}{rgb}{0.10,0.10,0.10}
\date{2016-03-19 @ Chemnitzer Linux Tage}
...
\begin{frame}
    ...
    \hspace{1em}
    \tiny\url{https://github.com/immobilienscout24/afp-talk}
    \begin{tabular}[t]{lr}
...
\includegraphics[height=1cm,width=2cm]{images/logo.pdf}
\end{textblock*}}
